...
public class ExampleTest {
	...
	public void test() throws NoSuchPatient, NoSuchDoctor {
		...
		String s = "P;Dentis;Lorenzo;DNTLNZ\n"
				+ "P;Abram;Andrea;NDRBRM\n"
				+ "M;31;Luca;Crupi;LCUCRP;Informatica\n"
				+ "M;Luca;Crupi;LCUCRP;31;Informatica\n"
				+ "P;Luca;Crupi;LCUCRP;31;Informatica";
		Reader reader = new StringReader(s);
		try {
			hospital.loadData(reader);
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		hospital.doctorsByNumPatients().forEach(System.out::println);
		System.out.println();
		hospital.countPatientsPerSpecialization().forEach(System.out::println);
	}
